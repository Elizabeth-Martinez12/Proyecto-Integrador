            ...
            <div class="sidebar-heading"><img src="https://upn113leon.edu.mx/wp-content/uploads/2022/08/UPN-png.png"
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<?php echo base_url('auditor/inicioauditor'); ?>" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="<?php echo base_url('auditor/aula/mostrar'); ?>" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= base_url('auditor/inventario/mostrar') ?>" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= base_url('auditor/mantenimiento/mostrar') ?>" class="sidebar-link">
