            ...
            <div class="col-12">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <form action="<?= base_url('inventa/inventario/mostrar') ?>" method="POST"
                                class="form-inline">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="acciones">
                                <a href="<?= base_url('inventa/inventario/generarQR/'.$inventa->id); ?>"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="<?= base_url('inventa/qr/' . $inventa->id . '.png'); ?>"
                                                    alt="Código QR de <?= $inventa->nombre; ?>" class="img-fluid">
                                            </div>
                                            <div class="modal-footer">
                                                <a href="<?= base_url('inventa/qr/' . $inventa->id . '.png'); ?>"
...
document.getElementById('generateGeneralReport').addEventListener('click', function() {
        window.location.href = '<?= base_url('inventa/Inventario-General-PDF'); ?>';
    });

    document.getElementById('generateAulaReport').addEventListener('click', function() {
        window.location.href = '<?= base_url('inventa/Inventario-PDF/'); ?>';
    });
</script>
