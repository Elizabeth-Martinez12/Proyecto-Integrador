...
<body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <a href="<?= base_url('inventa/inicioinventa'); ?>">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <form action="<?= base_url('inventa/aula/listaelemento') ?>" method="POST"
                                class="form-inline">
    ...
    document.getElementById('generateGeneralReport').addEventListener('click', function() {
        window.location.href = '<?= base_url('inventa/Aula-General-PDF'); ?>';
    });

    document.getElementById('generateAulaReport').addEventListener('click', function() {
        window.location.href = '<?= base_url('inventa/Aula-PDF/' . $idAula); ?>';
    });
    </script>
</body>
