...
-- Tiempo de generación: 20-05-2024 a las 06:03:21
...
(1, 'Proyector', 'Obsoleto', '2024-04-01', '2024-04-03 00:00:00', NULL, NULL),
(2, 'Silla', 'Irreparable', '2024-04-02', '2024-04-03 00:00:00', NULL, NULL),
(3, 'Computadora', 'Dañado', '2024-04-03', '2024-04-03 00:00:00', NULL, NULL),
(4, 'Impresora', 'Obsoletos', '2024-04-04', '2024-04-03 00:00:00', NULL, NULL),
(5, 'Pizarron', 'Desgaste severo', '2024-04-05', '2024-04-03 00:00:00', NULL, NULL);
...
(3, 3, 0x68747470733a2f2f6f6669677275702e6d782f696d6167652f63616368652f646174612f35352d363030783630302e6a7067, 4, 1, 'Mesa de madera', 1, 0x71725f636f646533, '2024-04-03 00:00:00', NULL, NULL),
...
(14, 1, '', 4, 1, 'Mesa azul con patas negras', 1, '', '0000-00-00 00:00:00', NULL, NULL),
...
CREATE TABLE `reparacion` (
  `id` int NOT NULL,
  `nombre` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `tipoReparacion` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `reparacion` (`id`, `nombre`, `tipoReparacion`, `fechaIngreso`, `fechaSalida`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Proyector', 'Cambio de lámpara', '2024-04-01', '2024-04-02', '2024-04-03 00:00:00', NULL, NULL),
(2, 'Pizarron', 'Cambio de bordes', '2024-04-02', '2024-04-03', '2024-04-03 00:00:00', NULL, NULL),
(3, 'Mesa', 'Reemplazo de patas', '2024-04-03', '2024-04-04', '2024-04-03 00:00:00', NULL, NULL),
(4, 'Silla', 'Revisión de estado', '2024-04-04', '2024-04-05', '2024-04-03 00:00:00', NULL, NULL),
(5, 'Teclado', 'Revision de funciones', '2024-04-05', '2024-04-06', '2024-04-03 00:00:00', NULL, NULL);
...
CREATE TABLE `reporte` (
  ...
  `ArtExistentes` int NOT NULL,
  `ArtReparacion` int NOT NULL,
  `ArtDescontinuo` int NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reporte` (`id`, `idAula`, `fechaReporte`, `ArtExistentes`, `ArtReparacion`, `ArtDescontinuo`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '2024-04-05', 5, 1, 1, '2024-04-03 00:00:00', NULL, NULL),
(2, 2, '2024-04-06', 3, 1, 1, '2024-04-03 00:00:00', NULL, NULL),
(3, 3, '2024-04-07', 4, 1, 2, '2024-04-03 00:00:00', NULL, NULL),
(4, 4, '2024-04-08', 2, 2, 1, '2024-04-03 00:00:00', NULL, NULL),
(5, 5, '2024-04-09', 3, 1, 1, '2024-04-03 00:00:00', NULL, NULL);
...
ALTER TABLE `reporte`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idAula` (`idAula`),
  ADD KEY `ArtReparacion` (`ArtReparacion`),
  ADD KEY `ArtDescontinuo` (`ArtDescontinuo`);
...
--
ALTER TABLE `reporte`
  ADD CONSTRAINT `reporte_ibfk_1` FOREIGN KEY (`idAula`) REFERENCES `aula` (`id`),
  ADD CONSTRAINT `reporte_ibfk_2` FOREIGN KEY (`ArtReparacion`) REFERENCES `reparacion` (`id`),
  ADD CONSTRAINT `reporte_ibfk_3` FOREIGN KEY (`ArtDescontinuo`) REFERENCES `descontinuado` (`id`);
